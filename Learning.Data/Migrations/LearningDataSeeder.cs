...
namespace Learning.Data.Migrations
{
    internal class LearningDataSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < tutorNames.Length; i++)
                {
                    ...
                    var tutor = new Tutor
                    {
                        Email = $"{nameGenderMail[0]}.{nameGenderMail[1]}@{nameGenderMail[3]}",
                    ...
                    var courseSubject = _ctx.Subjects.Single(s => s.Id == i + 1);
                ...
                for (int i = 0; i < studentNames.Length; i++)
                {
                    ...
                    for (int z = 0; z < 4; z++)
                    {
                        ...
                        {
                            Student = student,
                            Course = _ctx.Courses.Single(c => c.Id == randomCourseId),
        ...
        static readonly IList<CoursesSeed> CoursesSeedData = new List<CoursesSeed>
        {
